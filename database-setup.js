...
async function setupDatabase(clientOrSql) {
    ...
    try {
        ...
        await db.query(`
            ...
            END $$;
        `);
        console.log("✅ [Database] Database wiped successfully! Building exact schema...");
    } catch (e) {
    ...
    try {
        ...
        console.log("[Database] ✅ Exact matching schema built successfully and ready for migration!");
    } catch (e) {
