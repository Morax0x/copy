...
function setupDatabase(clientOrSql) {
    ...
    const tables = [
        ...
        "CREATE TABLE IF NOT EXISTS dungeon_saves (hostID TEXT PRIMARY KEY, guildID TEXT, floor INTEGER, timestamp INTEGER)"
    ];
