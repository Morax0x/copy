...
async function startDungeon(interaction, sql) {
    ...
    if (interaction.isButton() && interaction.customId === 'dungeon_campfire') {
        ...
        // حفظ البيانات في جدول dungeon_saves
        ...
        activeDungeonRequests.delete(data.hostID); // إزالة القائد من قائمة الانتظار إن وجد
