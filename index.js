...
try {
    ...
    if (typeof setupDatabase !== 'function') throw new Error("Missing setupDatabase function in database-setup.js");
    setupDatabase(db);
    if (aiConfig && typeof aiConfig.init === 'function') aiConfig.init();
} catch (err) {
