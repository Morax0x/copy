module.exports = (client, db) => {
    ...
    client.defaultData = { 
        ...
        lastdungeon: 0 // 🔥 تم إضافة العمود الجديد هنا
    };

    // 🔥 تم إضافة أعمدة الإحصائيات والأوسمة الجديدة هنا
    const defaultDailyStats = { messages: 0, images: 0, stickers: 0, emojis_sent: 0, reactions_added: 0, replies_sent: 0, mentions_received: 0, vc_minutes: 0, water_tree: 0, counting_channel: 0, meow_count: 0, streaming_minutes: 0, disboard_bumps: 0, boost_channel_reactions: 0, topgg_votes: 0, main_chat_messages: 0, chatter_badge_given: 0, daily_badge_given: 0, knight_badge_given: 0 };
    
    // 🔥 تم إضافة أعمدة الأوسمة الأسبوعية
    const defaultWeeklyStats = { messages: 0, images: 0, stickers: 0, emojis_sent: 0, reactions_added: 0, replies_sent: 0, mentions_received: 0, vc_minutes: 0, water_tree: 0, counting_channel: 0, meow_count: 0, streaming_minutes: 0, disboard_bumps: 0, topgg_votes: 0, weekly_badge_given: 0 };
    ...
    client.setLevel = async function(data) {
        ...
        const query = `
            INSERT INTO levels (
                ...
                lastRace, lastTransferDate, dailyTransferCount, lastdungeon
            ) VALUES (
                ...
                lastRace = EXCLUDED.lastRace, lastTransferDate = EXCLUDED.lastTransferDate, dailyTransferCount = EXCLUDED.dailyTransferCount, lastdungeon = EXCLUDED.lastdungeon;
        `;
        db.query(query, [
            ...
            Number(data.lastRace ?? data.lastrace) || 0, data.lastTransferDate ?? data.lasttransferdate ?? '', Number(data.dailyTransferCount ?? data.dailytransfercount) || 0, Number(data.lastdungeon) || 0
